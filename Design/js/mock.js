...
window.MOCK = {
  ...
  ambientAgents: [
    { id: "scout-01",   label: "scout-01",   meta: "chain 5031",  q: null },
  ...
  capabilities: [
    {
      ...
      body: "reads source, bytecode, storage slots — flags backdoors, infinite mints, ownership traps.",
      example: "audit 0xabc…",
      glyph: "contract",
    },
    {
      title: "fund-flow tracing",
      body: "graph-walks counterparties up to N hops. detects mixers, bridges, atomic splits.",
      example: "where did the airdrop go?",
      glyph: "flow",
    },
    {
      title: "stealth-launch detection",
      body: "finds projects building quietly — deployer wallets, factory contracts, pre-announcement activity.",
      example: "what is @project building?",
      glyph: "stealth",
    },
    {
      title: "wallet profiling",
      body: "behavioral fingerprint, counterparty graph, risk score, mev / sybil hints.",
      example: "profile 0xdef…",
      glyph: "wallet",
    },
    {
      title: "token & nft x-ray",
      body: "supply, holders, concentration, mint history, royalty traps, hidden permissions.",
      example: "x-ray token X",
      glyph: "xray",
    },
    {
      title: "continuous watch",
      body: "tell the swarm to keep watching. on-chain ping when something changes.",
  ...
  dossier: {
    ...
    flagged: [
      { sev: "high", title: "owner-only mint, no timelock", body: "deployer retains unconstrained `_emergencyMint` after renounce signal.", ref: "tx 0xa1f…7c2" },
      { sev: "med", title: "mixer interaction at hop 2", body: "78.4% of value routed through known privacy cluster within 4 blocks.", ref: "tx 0x991…b04" },
      { sev: "low", title: "sybil split pattern", body: "12 receivers funded in <60s; common txnonce signature.", ref: "tx 0x331…fee" },
    ],
    citations: [
