        ...
        <div className="dossier">
          <div className="dossier-banner corners">
            ...
            <div className="lines">
              ...
              <div>
                <span className="prompt">&gt;</span> nodes <span className="n">{d.nodes}</span> · agents{" "}
                <span className="n">{d.agents}</span> · duration <span className="n">{d.duration}s</span> · cost{" "}
                <span className="n">{d.cost} STT</span>
              </div>
            </div>
            <div className="meta">
          ...
          <div className="dossier-panel dossier-summary">
            ...
            <ul>{d.summary.map((s, i) => <li key={i}>{s}</li>)}</ul>
          </div>
